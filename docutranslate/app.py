...
async def service_flat_translate(
        ...
        translation_review_language: Literal["source", "target"] = Form("target", description="审校批注语言：source 原文，target 译文"),
        translation_review_enable: bool = Form(False, description="[DOCX专用] 是否启用逐分块 AI 翻译审校评论"),
    ...
    payload_dict = {
        ...
        "translation_review_enable": translation_review_enable,
        "translation_review_language": translation_review_language,
        "separator": separator,
